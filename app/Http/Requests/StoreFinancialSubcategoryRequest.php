...
class StoreFinancialSubcategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'subcategories.*.active' => 'sometimes|boolean',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'subcategories.*.name.required_with' => 'O nome da subcategoria é obrigatório.',
            'subcategories.*.name.string' => 'O nome da subcategoria deve ser um texto.',
            'subcategories.*.name.max' => 'O nome da subcategoria não pode ter mais de 255 caracteres.',
        ];
    }
}
