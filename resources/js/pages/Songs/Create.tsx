        ...
        <AppPage>
            <PageCard title="Nova Música">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="mt-2">
                                    ...
                                    />
                                    <p className="mt-1 text-sm text-muted-foreground">Ex: adoração, louvor, comunhão</p>
                                </div>
                            </div>
                        </div>
                    </FormPanel>
                    ...
                    <FormActions>
                        <CancelButton href={route('songs.index')} />
                        <SaveButton processing={processing}>Cadastrar Música</SaveButton>
                    </FormActions>
                </form>
            </PageCard>
        </AppPage>
