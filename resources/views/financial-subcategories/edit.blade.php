<x-app-layout>
    <x-page-card title="Editar Subcategoria Financeira">
        ...
        <form action="{{ route('financial.subcategories.update', $financialSubcategory) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex flex-col items-start gap-1">
                        ...
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="active" value="1" class="sr-only peer" {{ old('active', $financialSubcategory->active) ? 'checked' : '' }}>
