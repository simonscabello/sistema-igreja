<x-app-layout>
    <x-page-card title="Relatório Financeiro Mensal">
        ...
        <div class="mb-6 flex flex-wrap gap-2">
            ...
            <span class="inline-flex items-center px-3 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-md">
                Relatório Mensal
            </span>
            ...
            <a href="{{ route('financial.reports.annual.summary') }}" class="inline-flex items-center px-3 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200">
                Anual Simplificado
            </a>
        </div>
        ...
        <!-- Filtro -->
        <div class="mb-6">
            <form action="{{ route('financial.reports.monthly') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                <div>
                    <x-select
                        label="Mês"
                        name="month"
