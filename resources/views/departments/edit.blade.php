<x-app-layout>
    <x-page-card title="Editar Departamento">
        @if($errors->any())
        ...
        <form action="{{ route('departamentos.update', $departamento) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <x-text-input label="Título" name="title" :value="old('title', $departamento->title)" placeholder="Digite o título do departamento" required />
