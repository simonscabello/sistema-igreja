            ...
            <div class="max-w-2xl">
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <x-input-date name="start_date" label="Data de Início" class="mt-1 block w-full" :value="old('start_date', $campaign->start_date?->format('d/m/Y'))" />
                            <x-input-error :messages="$errors->get('start_date')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-date name="end_date" label="Data de Término" class="mt-1 block w-full" :value="old('end_date', $campaign->end_date?->format('d/m/Y'))" />
