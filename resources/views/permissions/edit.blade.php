<x-app-layout>
    <x-page-card title="Editar Permissão">
        @if($errors->any())
        ...
        <form action="{{ route('permissions.update', $permission) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-4">
                <x-text-input label="Nome" name="name" :value="old('name', $permission->name)" placeholder="Digite o nome da permissão" required="true" />
